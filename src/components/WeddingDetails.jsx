...
export const WeddingDetails = (props) => {
  return (
    <div className={ (props.className) ? 'details-container ' + props.className : 'details-container'}>
      <h1>{ props.title }</h1>
      <div className='location'>{ props.location }(<a target='_blank' className='google-map-link' href='https://www.google.com/maps/place/National+Tropical+Botanical+Garden/@21.8875034,-159.4949768,17z/data=!4m8!1m2!2m1!1skauai+national+tropical+botanical+garden!3m4!1s0x0:0x39440497f2d853e5!8m2!3d21.886686!4d-159.4926238'> Google Map </a>)</div>
